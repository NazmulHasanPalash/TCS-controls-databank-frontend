...
import './SalesCreateFolder.css';

/* ======================== Config ======================== */
const RAW_API_BASE =
  process.env.REACT_APP_API_BASE || 'https://databank.tcscontrols.com.my';
const SALES_BASE = process.env.REACT_APP_SALES_BASE || '/sales';
...
function resolveParentPath(currentFolder) {
  ...
  const parts = [SALES_BASE, ...names, leafName].filter(Boolean);
...
SalesCreateFolder.propTypes = {
  currentFolder: PropTypes.oneOfType([PropTypes.object, PropTypes.string]),
  onSalesCreateFolder: PropTypes.func, // (meta) => void
...
SalesCreateFolder.defaultProps = {
  currentFolder: 'root folder',
  onSalesCreateFolder: undefined,
  siblings: undefined,
...
export default SalesCreateFolder;
