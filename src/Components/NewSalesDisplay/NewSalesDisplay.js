// src/Components/NewSalesDisplay/NewSalesDisplay.jsx
import React, {
  useCallback,
  useEffect,
  useMemo,
...
import './NewSalesDisplay.css';

import BredCrum from '../BreadCrum/BreadCrum';
import NewSalesUploadFolder from '../NewSalesUploadFolder/NewSalesUploadFolder';
import NewSalesCreateFolder from '../NewSalesCreateFolder/NewSalesCreateFolder';
import NewSalesUploadFile from '../NewSalesUploadFile/NewSalesUploadFile';
...
const START_PATH =
  (process.env.REACT_APP_NEW_SALES_BASE || '/new-sales').replace(/\/+$/, '') ||
  '/new-sales';
      ...
      <div className="libd-toolbar">
        ...
        <div className="libd-toolbar-row libd-toolbar-actions">
          <div className="libd-actions">
            <NewSalesUploadFile currentPath={path} onFileUploaded={fetchList} />
            <NewSalesUploadFolder
              currentPath={path}
              onFolderUploaded={handleFolderUploaded}
            />
            <NewSalesCreateFolder
              currentFolder={{
                fullPath: path,
                name: path.split('/').filter(Boolean).pop() || 'new-sales',
              }}
              onNewSalesCreateFolder={fetchList}
...
NewSalesDisplay.propTypes = {};

export default NewSalesDisplay;
