// src/Components/NewFinanceDisplay/NewFinanceDisplay.jsx
import React, {
  useCallback,
  useEffect,
  useMemo,
...
// Base path for New Finance area
const START_PATH =
  (process.env.REACT_APP_NEW_FINANCE_BASE || '/new-finance').replace(
    /\/+$/,
    ''
  ) || '/new-finance';
        ...
        <div className="libd-toolbar-row libd-toolbar-actions">
          <div className="libd-actions">
            ...
            <NewFinanceCreateFolder
              currentFolder={{
                fullPath: path,
                name: path.split('/').filter(Boolean).pop() || 'new-finance',
              }}
...
NewFinanceDisplay.propTypes = {};

export default NewFinanceDisplay;
