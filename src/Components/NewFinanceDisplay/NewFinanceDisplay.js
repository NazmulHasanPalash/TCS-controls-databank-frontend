// src/Components/NewFinanceDispaly/NewFinanceDispaly.jsx
import React, {
  useCallback,
  useEffect,
  useMemo,
...
import './NewFinanceDisplay.css';

import BredCrum from '../BreadCrum/BreadCrum';
import NewFinanceUploadFolder from '../NewFinanceUploadFolder/NewFinanceUploadFolder';
import NewFinanceCreateFolder from '../NewFinanceCreateFolder/NewFinanceCreateFolder';
import NewFinanceUploadFile from '../NewFinanceUploadFile/NewFinanceUploadFile';
...
const START_PATH =
  (process.env.REACT_APP_FINANCE_START_PATH || '/new-finance').replace(
    /\/+$/,
    ''
  ) || '/new-finance';
        ...
        <div className="libd-toolbar">
          ...
          <div className="libd-toolbar-row libd-toolbar-actions">
            <div className="libd-actions">
              <NewFinanceUploadFile
                currentPath={path}
                onFileUploaded={fetchList}
              />
              <NewFinanceUploadFolder
                currentPath={path}
                onFolderUploaded={handleFolderUploaded}
              />
              <NewFinanceCreateFolder
                currentFolder={{
                  fullPath: path,
                  name: path.split('/').filter(Boolean).pop() || 'finance',
                }}
                onNewFinanceCreateFolder={fetchList}
...
NewFinanceDispaly.propTypes = {};

export default NewFinanceDispaly;
