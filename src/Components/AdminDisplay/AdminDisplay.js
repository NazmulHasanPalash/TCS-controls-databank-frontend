...
import AdminUploadFolder from '../AdminUploadFolder/AdminUploadFolder';
import AdminCreateFolder from '../AdminCreateFolder/AdminCreateFolder';
import AdminUploadFile from '../AdminUploadFile/AdminUploadFile';
...
const START_PATH =
  (process.env.REACT_APP_START_PATH || '/admin').replace(/\/+$/, '') ||
  '/admin';
        ...
        <div className="libd-toolbar-row libd-toolbar-actions">
          <div className="libd-actions">
            ...
            <AdminCreateFolder
              currentFolder={{
                fullPath: path,
                name: path.split('/').filter(Boolean).pop() || 'admin',
              }}
              // Support either prop name your component might expect:
              onAdminCreateFolder={fetchList}
