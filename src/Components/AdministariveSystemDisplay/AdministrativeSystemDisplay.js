// AdministrativeSystemDisplay.jsx
import React, {
  useCallback,
  useEffect,
  useMemo,
...
import './AdministrtiveSystemDisplay.css';

import BredCrum from '../BreadCrum/BreadCrum';
import AdministrativeSystemUploadFolder from '../AdministrativeSystemUploadFolder/AdministrativeSystemUploadFolder';
import AdministrativeSystemCreateFolder from '../AdministrativeSystemCreateFolder/AdministrativeSystemCreateFolder';
import AdministrativeSystemUploadFile from '../AdministrativeSystemUploadFile/AdministrativeSystemUploadFile';
...
const START_PATH =
  (
    process.env.REACT_APP_ADMIN_SYSTEM_START_PATH ||
    process.env.REACT_APP_ADMIN_SYSTEM_BASE ||
    '/administrative-system'
  ).replace(/\/+$/, '') || '/administrative-system';
...
/* ================= Component ================= */
function AdministrativeSystemDisplay() {
  ...
  const fetchList = useCallback(async () => {
    ...
    try {
      ...
      setFolderSizes({}); // reset folder-size cache on list refresh
    } catch (err) {
    ...
    // Cleanup of controller is handled by aborting when needed elsewhere,
    // so we don't return a cleanup function from here.
  }, [path]);
      ...
      <div className="libd-toolbar">
        ...
        <div className="libd-toolbar-row libd-toolbar-actions">
          <div className="libd-actions">
            <AdministrativeSystemUploadFile
              currentPath={path}
              onFileUploaded={fetchList}
            />
            <AdministrativeSystemUploadFolder
              currentPath={path}
              onFolderUploaded={handleFolderUploaded}
            />
            <AdministrativeSystemCreateFolder
              currentFolder={{
                fullPath: path,
                name:
              ...
              onAdministrativeSystemCreateFolder={fetchList}
...
AdministrativeSystemDisplay.propTypes = {};

export default AdministrativeSystemDisplay;
