// src/Components/AdministrativeSystemDisplay/AdministrativeSystemDisplay.jsx
import React, {
  useCallback,
  useEffect,
  useMemo,
...
import './AdministrativeSystemDisplay.css';
...
const START_PATH =
  (
    process.env.REACT_APP_ADMINISTRATIVE_SYSTEM_START_PATH ||
