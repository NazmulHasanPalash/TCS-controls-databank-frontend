// src/Components/FinanceDisplay/FinanceDisplay.jsx
import React, {
  useCallback,
  useEffect,
  useMemo,
...
import './FinanceDisplay.css';

import BredCrum from '../BreadCrum/BreadCrum';
import FinanceUploadFolder from '../FinanceUploadFolder/FinanceUploadFolder';
import FinanceCreateFolder from '../FinanceCreateFolder/FinanceCreateFolder';
import FinanceUploadFile from '../FinanceUploadFile/FinanceUploadFile';
...
const START_PATH =
  (process.env.REACT_APP_FINANCE_START_PATH || '/finance').replace(
    /\/+$/,
    ''
  ) || '/finance';
      ...
      <div className="libd-toolbar">
        ...
        <div className="libd-toolbar-row libd-toolbar-actions">
          <div className="libd-actions">
            <FinanceUploadFile currentPath={path} onFileUploaded={fetchList} />
            <FinanceUploadFolder
              currentPath={path}
            ...
            <FinanceCreateFolder
              ...
              onFinanceCreateFolder={fetchList}
