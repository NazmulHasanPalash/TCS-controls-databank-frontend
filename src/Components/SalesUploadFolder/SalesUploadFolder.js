// src/Components/SalesUploadFolder/SalesUploadFolder.jsx
...
const SALES_ROOT = process.env.REACT_APP_SALES_START_PATH || '/sales';
...
const clampToSales = (dest) => {
  const root = normalizePath(SALES_ROOT);
...
/* ================= Component ================= */
function SalesUploadFolder({ currentPath, userId, onFolderUploaded }) {
  ...
  const destBase = clampToSales(currentPath || SALES_ROOT);
...
SalesUploadFolder.propTypes = {
  currentPath: PropTypes.string,
  userId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  onFolderUploaded: PropTypes.func,
};

export default SalesUploadFolder;
