// src/Components/OperatorUploadFolder/OperatorUploadFolder.jsx
...
import './OperatorUploadFolder.css';

/* ================= Config ================= */
const API_BASE = process.env.REACT_APP_API_BASE || 'http://localhost:5000';
/** Hard root: cannot upload above this path */
const OPERATOR_ROOT = process.env.REACT_APP_OPERATOR_START_PATH || '/operator';
...
/* ================= Component ================= */
function OperatorUploadFolder({ currentPath, userId, onFolderUploaded }) {
  ...
  const destBase = clampToOperator(currentPath || OPERATOR_ROOT);
...
OperatorUploadFolder.propTypes = {
  currentPath: PropTypes.string,
  userId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  onFolderUploaded: PropTypes.func,
};

export default OperatorUploadFolder;
