// src/Components/ProductionUploadFolder/ProductionUploadFolder.jsx
...
import './ProductionUploadFolder.css';
...
/** Hard root: cannot upload above this path (Production) */
const PROD_ROOT = process.env.REACT_APP_PRODUCTION_START_PATH || '/production';
...
const clampToProduction = (dest) => {
  const root = normalizePath(PROD_ROOT);
...
/* ================= Component ================= */
function ProductionUploadFolder({ currentPath, userId, onFolderUploaded }) {
  ...
  const destBase = clampToProduction(currentPath || PROD_ROOT);
...
ProductionUploadFolder.propTypes = {
  currentPath: PropTypes.string,
  userId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  onFolderUploaded: PropTypes.func,
};

export default ProductionUploadFolder;
