// src/Components/CustomerOrderUploadFile/CustomerOrderUploadFile.jsx
...
/* ================= Component ================= */
const CustomerOrderUploadFile = ({ currentPath, userId, onFileUploaded }) => {
...
CustomerOrderUploadFile.propTypes = {
  /** The exact path the user is viewing (e.g. "/customer-order", "/customer-order/2024/PO123") */
...
export default CustomerOrderUploadFile;
