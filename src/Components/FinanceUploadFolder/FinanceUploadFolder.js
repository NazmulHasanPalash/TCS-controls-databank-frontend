// src/Components/FinanceUploadFolder/FinanceUploadFolder.jsx
...
import './FinanceUploadFolder.css';
...
const FIN_ROOT = process.env.REACT_APP_FINANCE_START_PATH || '/finance';
...
const clampToFinance = (dest) => {
  const root = normalizePath(FIN_ROOT);
...
/* ================= Component ================= */
function FinanceUploadFolder({ currentPath, userId, onFolderUploaded }) {
  ...
  const destBase = clampToFinance(currentPath || FIN_ROOT);
...
FinanceUploadFolder.propTypes = {
  currentPath: PropTypes.string,
  userId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  onFolderUploaded: PropTypes.func,
};

export default FinanceUploadFolder;
