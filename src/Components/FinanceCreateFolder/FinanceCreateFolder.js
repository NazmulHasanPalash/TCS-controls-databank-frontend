// src/Components/FinanceCreateFolder/FinanceCreateFolder.jsx
...
import './FinanceCreateFolder.css';

/* ======================== Config ======================== */
const RAW_API_BASE =
  process.env.REACT_APP_API_BASE || 'https://databank.tcscontrols.com.my';
const FIN_BASE = process.env.REACT_APP_FINANCE_BASE || '/finance';
...
function resolveParentPath(currentFolder) {
  ...
  const parts = [FIN_BASE, ...names, leafName].filter(Boolean);
...
const FinanceCreateFolder = ({
  currentFolder,
  onFinanceCreateFolder,
  siblings,
  buttonVariant,
  buttonClassName,
  modalTitle,
...
FinanceCreateFolder.propTypes = {
  currentFolder: PropTypes.oneOfType([PropTypes.object, PropTypes.string]),
  onFinanceCreateFolder: PropTypes.func, // (meta) => void
...
FinanceCreateFolder.defaultProps = {
  currentFolder: 'root folder',
  onFinanceCreateFolder: undefined,
  siblings: undefined,
...
export default FinanceCreateFolder;
