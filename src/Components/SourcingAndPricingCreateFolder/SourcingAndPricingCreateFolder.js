...
function resolveParentPath(currentFolder) {
  ...
  const parts = [SNP_BASE, ...names, leafName].filter(Boolean);
      ...
      <Modal show={show} onHide={() => setShow(false)} centered>
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group controlId="formSnpFolderName" className="mb-3">
              <Form.Control
                type="text"
...
SourcingAndPricingCreateFolder.propTypes = {
...
SourcingAndPricingCreateFolder.defaultProps = {
  currentFolder: 'root folder',
...
export default SourcingAndPricingCreateFolder;
