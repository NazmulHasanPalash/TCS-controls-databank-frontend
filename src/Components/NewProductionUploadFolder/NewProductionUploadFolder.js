// src/Components/NewProductionUploadFolder/NewProductionUploadFolder.jsx
...
import './NewProductionUploadFolder.css';
...
const clampToNewProduction = (dest) => {
  const root = normalizePath(NEW_PRODUCTION_ROOT);
...
/* ================= Component ================= */
function NewProductionUploadFolder({ currentPath, userId, onFolderUploaded }) {
  ...
  const destBase = clampToNewProduction(currentPath || NEW_PRODUCTION_ROOT);
...
NewProductionUploadFolder.propTypes = {
  currentPath: PropTypes.string,
  userId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  onFolderUploaded: PropTypes.func,
};

export default NewProductionUploadFolder;
