// src/Components/LibraryUploadFolder/LibraryUploadFolder.jsx
...
/* ================= Component ================= */
function LibraryUploadFolder({ currentPath, userId, onFolderUploaded }) {
  ...
  const destBase = clampToLibrary(currentPath || LIB_ROOT);
...
LibraryUploadFolder.propTypes = {
  currentPath: PropTypes.string,
  userId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  onFolderUploaded: PropTypes.func,
};

export default LibraryUploadFolder;
