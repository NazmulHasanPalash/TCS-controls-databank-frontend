// src/Components/NewAdministrationUploadFolder/NewAdministrationUploadFolder.jsx
...
import './NewAdministrationUploadFolder.css';
...
/** Hard root: cannot upload above this path (new-administration area) */
const ADMIN_ROOT =
...
/* ================= Component ================= */
function NewAdministrationUploadFolder({
  currentPath,
  userId,
  onFolderUploaded,
}) {
  ...
  const destBase = clampToAdmin(currentPath || ADMIN_ROOT);
...
NewAdministrationUploadFolder.propTypes = {
  currentPath: PropTypes.string,
  userId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  onFolderUploaded: PropTypes.func,
};

export default NewAdministrationUploadFolder;
