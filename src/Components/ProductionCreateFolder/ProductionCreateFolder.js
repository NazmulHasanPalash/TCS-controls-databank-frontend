...
import './ProductionCreateFolder.css';

/* ======================== Config ======================== */
const RAW_API_BASE =
  process.env.REACT_APP_API_BASE || 'https://databank.tcscontrols.com.my';
const PROD_BASE = process.env.REACT_APP_PRODUCTION_BASE || '/production';
...
function resolveParentPath(currentFolder) {
  ...
  const parts = [PROD_BASE, ...names, leafName].filter(Boolean);
...
ProductionCreateFolder.propTypes = {
...
ProductionCreateFolder.defaultProps = {
  currentFolder: 'root folder',
...
export default ProductionCreateFolder;
