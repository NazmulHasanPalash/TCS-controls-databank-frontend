...
import './HrCreateFolder.css';

/* ======================== Config ======================== */
const RAW_API_BASE =
  process.env.REACT_APP_API_BASE || 'https://databank.tcscontrols.com.my';
const HR_BASE = process.env.REACT_APP_HR_BASE || '/hr';
...
function resolveParentPath(currentFolder) {
  ...
  const parts = [HR_BASE, ...names, leafName].filter(Boolean);
...
HrCreateFolder.defaultProps = {
  currentFolder: 'root folder',
  onHrCreateFolder: undefined,
  siblings: undefined,
