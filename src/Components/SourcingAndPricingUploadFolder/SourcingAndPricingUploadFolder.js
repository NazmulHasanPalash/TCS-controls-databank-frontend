// src/Components/SourcingAndPricingUploadFolder/SourcingAndPricingUploadFolder.jsx
...
function SourcingAndPricingUploadFolder({
  ...
  const destBase = clampToRoot(currentPath || SNP_ROOT);
    ...
    try {
      const res = await axios.post(`${API_BASE}/api/upload-folder`, fd, {
        ...
        onUploadProgress: (evt) => {
          ...
          // % uses selected folder size (expectedBytes) — stable across browsers
...
SourcingAndPricingUploadFolder.propTypes = {
  /** The folder you’re currently viewing (e.g. "/sourcing-pricing", "/sourcing-pricing/sub/dir") */
...
export default SourcingAndPricingUploadFolder;
