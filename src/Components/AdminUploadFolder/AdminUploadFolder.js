// src/Components/AdminUploadFolder/AdminUploadFolder.jsx
...
import './AdminUploadFolder.css';

/* ================= Config ================= */
const API_BASE = process.env.REACT_APP_API_BASE || 'http://localhost:5000';
/** Hard root: cannot upload above this path */
const ADMIN_ROOT = process.env.REACT_APP_ADMIN_START_PATH || '/admin';
...
/* ================= Component ================= */
function AdminUploadFolder({ currentPath, userId, onFolderUploaded }) {
...
AdminUploadFolder.propTypes = {
  currentPath: PropTypes.string,
  userId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  onFolderUploaded: PropTypes.func,
};

export default AdminUploadFolder;
