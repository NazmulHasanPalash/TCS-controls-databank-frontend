...
function resolveParentPath(currentFolder) {
  ...
  const parts = [NEW_FINANCE_BASE, ...names, leafName].filter(Boolean);
...
const NewFinanceCreateFolder = ({
  currentFolder,
  onNewFinanceCreateFolder,
  siblings,
  buttonVariant,
  buttonClassName,
  modalTitle,
...
NewFinanceCreateFolder.propTypes = {
  currentFolder: PropTypes.oneOfType([PropTypes.object, PropTypes.string]),
  onNewFinanceCreateFolder: PropTypes.func, // (meta) => void
...
NewFinanceCreateFolder.defaultProps = {
  currentFolder: 'root folder',
  onNewFinanceCreateFolder: undefined,
  siblings: undefined,
...
export default NewFinanceCreateFolder;
