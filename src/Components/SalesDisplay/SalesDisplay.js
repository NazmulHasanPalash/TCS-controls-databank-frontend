// src/Components/SalesDisplay/SalesDisplay.jsx
import React, {
  useCallback,
  useEffect,
  useMemo,
...
import SalesUploadFolder from '../SalesUploadFolder/SalesUploadFolder';
import SalesCreateFolder from '../SalesCreateFolder/SalesCreateFolder';
import SalesUploadFile from '../SalesUploadFile/SalesUploadFile';
...
const START_PATH =
  (process.env.REACT_APP_SALES_START_PATH || '/sales').replace(/\/+$/, '') ||
  '/sales';
        ...
        <div className="libd-toolbar">
          ...
          <div className="libd-toolbar-row libd-toolbar-actions">
            <div className="libd-actions">
              <SalesUploadFile currentPath={path} onFileUploaded={fetchList} />
              <SalesUploadFolder
                currentPath={path}
              ...
              <SalesCreateFolder
                currentFolder={{
                  fullPath: path,
                  name: path.split('/').filter(Boolean).pop() || 'sales',
                }}
                onSalesCreateFolder={fetchList}
