// src/Components/AdministrativeSystemUploadFolder/AdministrativeSystemUploadFolder.jsx
...
import './AdministrativeSystemUploadFolder.css';
...
const clampToAdministrativeSystem = (dest) => {
  const root = normalizePath(ADMIN_SYSTEM_ROOT);
...
/* ================= Component ================= */
function AdministrativeSystemUploadFolder({
  currentPath,
  userId,
  onFolderUploaded,
}) {
  ...
  const destBase = clampToAdministrativeSystem(
          ...
          {uploadedSummary ? (
            ...
            <>
              <Form onSubmit={handleFolderSubmit} encType="multipart/form-data">
                ...
                {/* Folder selection */}
                <Form.Group controlId="formAdminSystemFolder" className="my-2">
                  ...
                  {selectedMeta && (
                    <div className="mt-2 small">
                      Selected files:&nbsp;
                      <strong>{selectedMeta.count}</strong>
                      &nbsp;• Folder size:&nbsp;
...
AdministrativeSystemUploadFolder.propTypes = {
  currentPath: PropTypes.string,
  userId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  onFolderUploaded: PropTypes.func,
};

export default AdministrativeSystemUploadFolder;
