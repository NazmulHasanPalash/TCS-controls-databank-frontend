// src/Components/AdministrativeUploadFolder/AdministrativeUploadFolder.jsx
...
/* ================= Component ================= */
function AdministrativeUploadFolder({ currentPath, userId, onFolderUploaded }) {
  ...
  const destBase = clampToAdministrative(currentPath || ADMIN_ROOT);
...
export default AdministrativeUploadFolder;
