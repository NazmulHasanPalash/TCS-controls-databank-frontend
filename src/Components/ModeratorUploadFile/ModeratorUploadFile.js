// src/Components/ModeratorUploadFile/ModeratorUploadFile.jsx
...
/* ================= Component ================= */
const ModeratorUploadFile = ({ currentPath, userId, onFileUploaded }) => {
  ...
  const destPath = clampToModerator(currentPath || MOD_ROOT);
...
ModeratorUploadFile.propTypes = {
  /** The exact path the user is viewing (e.g. "/moderator", "/moderator/Docs/2024") */
...
export default ModeratorUploadFile;
