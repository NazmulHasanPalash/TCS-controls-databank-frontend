// src/Components/NewSalesUploadFolder/NewSalesUploadFolder.jsx
...
import './NewSalesUploadFolder.css';
...
const NEW_SALES_ROOT = process.env.REACT_APP_NEW_SALES_BASE || '/new-sales';
...
const clampToNewSales = (dest) => {
  const root = normalizePath(NEW_SALES_ROOT);
...
/* ================= Component ================= */
function NewSalesUploadFolder({ currentPath, userId, onFolderUploaded }) {
  ...
  const destBase = clampToNewSales(currentPath || NEW_SALES_ROOT);
...
NewSalesUploadFolder.propTypes = {
  currentPath: PropTypes.string,
  userId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  onFolderUploaded: PropTypes.func,
};

export default NewSalesUploadFolder;
