...
import './AdministrativeSystemCreateFolder.css';

/* ======================== Config ======================== */
const RAW_API_BASE =
  process.env.REACT_APP_API_BASE || 'https://databank.tcscontrols.com.my';
const ADMIN_SYSTEM_BASE =
  process.env.REACT_APP_ADMIN_SYSTEM_BASE || '/administrative-system';
...
function resolveParentPath(currentFolder) {
  ...
  const parts = [ADMIN_SYSTEM_BASE, ...names, leafName].filter(Boolean);
...
const AdministrativeSystemCreateFolder = ({
  currentFolder,
  onAdministrativeSystemCreateFolder,
  siblings,
  buttonVariant,
  buttonClassName,
  modalTitle,
      ...
      <Modal show={show} onHide={() => setShow(false)} centered>
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group controlId="formAdminSystemFolderName" className="mb-3">
              <Form.Control
                type="text"
...
AdministrativeSystemCreateFolder.propTypes = {
  currentFolder: PropTypes.oneOfType([PropTypes.object, PropTypes.string]),
  onAdministrativeSystemCreateFolder: PropTypes.func, // (meta) => void
...
AdministrativeSystemCreateFolder.defaultProps = {
  currentFolder: 'root folder',
  onAdministrativeSystemCreateFolder: undefined,
  siblings: undefined,
...
export default AdministrativeSystemCreateFolder;
