...
function resolveParentPath(currentFolder) {
  ...
  const parts = [CUST_BASE, ...names, leafName].filter(Boolean);
...
CustomerOrderCreateFolder.propTypes = {
  currentFolder: PropTypes.oneOfType([PropTypes.object, PropTypes.string]),
  onCustomerOrderCreateFolder: PropTypes.func, // (meta) => void
...
CustomerOrderCreateFolder.defaultProps = {
  currentFolder: 'root folder',
  onCustomerOrderCreateFolder: undefined,
  siblings: undefined,
...
export default CustomerOrderCreateFolder;
