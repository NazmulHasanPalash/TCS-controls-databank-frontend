// src/Components/ModeratorUploadFolder/ModeratorUploadFolder.jsx
...
import './ModeratorUploadFolder.css';
...
const MOD_ROOT = process.env.REACT_APP_MODERATOR_START_PATH || '/moderator';
...
/* ================= Component ================= */
function ModeratorUploadFolder({ currentPath, userId, onFolderUploaded }) {
  ...
  const destBase = clampToModerator(currentPath || MOD_ROOT);
...
ModeratorUploadFolder.propTypes = {
  currentPath: PropTypes.string,
  userId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  onFolderUploaded: PropTypes.func,
};

export default ModeratorUploadFolder;
