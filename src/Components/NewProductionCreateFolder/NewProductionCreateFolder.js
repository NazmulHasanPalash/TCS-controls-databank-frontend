// src/Components/NewProductionCreateFolder/NewProductionCreateFolder.jsx
...
import './NewProductionCreateFolder.css';

/* ======================== Config ======================== */
const RAW_API_BASE =
  process.env.REACT_APP_API_BASE || 'https://databank.tcscontrols.com.my';
const NEW_PRODUCTION_BASE =
  process.env.REACT_APP_NEW_PRODUCTION_BASE || '/new-production';
...
function resolveParentPath(currentFolder) {
  ...
  const parts = [NEW_PRODUCTION_BASE, ...names, leafName].filter(Boolean);
...
const NewProductionCreateFolder = ({
  currentFolder,
  onNewProductionCreateFolder,
  siblings,
  buttonVariant,
  buttonClassName,
  modalTitle,
...
NewProductionCreateFolder.propTypes = {
  currentFolder: PropTypes.oneOfType([PropTypes.object, PropTypes.string]),
  onNewProductionCreateFolder: PropTypes.func, // (meta) => void
...
NewProductionCreateFolder.defaultProps = {
  currentFolder: 'root folder',
  onNewProductionCreateFolder: undefined,
  siblings: undefined,
...
export default NewProductionCreateFolder;
