// src/Components/NewFinanceUploadFolder/NewFinanceUploadFolder.jsx
...
import './NewFinanceUploadFolder.css';
...
const clampToNewFinance = (dest) => {
  const root = normalizePath(NEW_FINANCE_ROOT);
...
/* ================= Component ================= */
function NewFinanceUploadFolder({ currentPath, userId, onFolderUploaded }) {
  ...
  const destBase = clampToNewFinance(currentPath || NEW_FINANCE_ROOT);
...
NewFinanceUploadFolder.propTypes = {
  currentPath: PropTypes.string,
  userId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  onFolderUploaded: PropTypes.func,
};

export default NewFinanceUploadFolder;
