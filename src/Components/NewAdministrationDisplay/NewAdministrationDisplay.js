// src/Components/NewAdministrationDisplay/NewAdministrationDisplay.jsx
import React, {
  useCallback,
  useEffect,
  useMemo,
...
const START_PATH =
  (
    process.env.REACT_APP_ADMINISTRATIVE_START_PATH || '/new-administration'
  ).replace(/\/+$/, '') || '/new-administration';
      ...
      <div className="libd-shell">
            ...
            <div className="libd-actions">
              ...
              <NewAdministrationCreateFolder
                currentFolder={{
                  fullPath: path,
                  name:
                    path.split('/').filter(Boolean).pop() || 'administrative',
                }}
        ...
        {ctxOpen && ctxTarget && (
          ...
          >
            ...
            {/* For files: preview + download. For folders: no download button now */}
