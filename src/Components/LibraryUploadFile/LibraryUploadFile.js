// src/Components/LibraryUploadFile/LibraryUploadFile.jsx
...
/* ================= Component ================= */
const LibraryUploadFile = ({ currentPath, userId, onFileUploaded }) => {
  ...
  const destPath = clampToLibrary(currentPath || LIB_ROOT);
...
LibraryUploadFile.propTypes = {
  /** The exact path the user is viewing (e.g. "/library", "/library/Docs/2024") */
