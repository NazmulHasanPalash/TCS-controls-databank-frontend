// src/Components/HrUploadFolder/HrUploadFolder.jsx
...
const HR_ROOT = process.env.REACT_APP_HR_START_PATH || '/hr';
...
const clampToHr = (dest) => {
  const root = normalizePath(HR_ROOT);
...
/* ================= Component ================= */
function HrUploadFolder({ currentPath, userId, onFolderUploaded }) {
  ...
  const destBase = clampToHr(currentPath || HR_ROOT);
...
HrUploadFolder.propTypes = {
  currentPath: PropTypes.string,
  userId: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  onFolderUploaded: PropTypes.func,
};

export default HrUploadFolder;
