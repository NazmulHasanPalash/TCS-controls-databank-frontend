// src/Components/ProductionDisplay/ProductionDisplay.jsx
import React, {
  useCallback,
  useEffect,
  useMemo,
...
import ProductionUploadFolder from '../ProductionUploadFolder/ProductionUploadFolder';
import ProductionCreateFolder from '../ProductionCreateFolder/ProductionCreateFolder';
import ProductionUploadFile from '../ProductionUploadFile/ProductionUploadFile';
...
const START_PATH =
  (process.env.REACT_APP_PRODUCTION_START_PATH || '/production').replace(
    /\/+$/,
    ''
  ) || '/production';
